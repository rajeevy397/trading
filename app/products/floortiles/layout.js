...
const Search_BY_Size_Floor = dynamic(
  () => import('../../components/Search_by_size_Floor'),
  {
    loading: () => <p>Loading...</p>,
  }
)
...
export default function RootLayout({children}){
    ...
    return(
        ...
        <Link href="/products/floortiles/bathroom"><button className={`px-3 py-1  ml-20 md:ml-0 hover:bg-blue-900 ${isActive==="bathroom"? "bg-blue-900":""}`}>Bathroom Floor Tiles</button> </Link>
